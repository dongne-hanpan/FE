const bowlingData = {
  ...
  4:[
    ...
    { region: '강서구', value:'볼원볼링장', address: "서울 강서구 강서로54길 42 2층,3층" },
  ...
  6:[
    { region: '광진구', value:'그랜드볼링센터', address: "서울 광진구 강변역로 50 동서울터미널 6층" },
  ...
  9:[
    ...
    { region: '노원구', value:'24시블랙홀 볼링센터', address: "서울 노원구 화랑로 325 4층 우현빌딩" },
  ...
  13:[
    ...
    { region: '마포구', value:'클럽스트라이크', address: "서울 마포구 마포대로 52 4층 클럽스트라이크" },
  ...
  15:[
    ...
    { region: '서초구', value:'코오롱스포렉스', address: "서울 서초구 서초대로70길 32 코오롱스포렉스" },
  ...
  18:[
    ...
    { region: '송파구', value:'스핀볼링센터 가든파이브', address: "서울 송파구 충민로 52 가든파이브 웍스관 지하1층 57호" },
    { region: '송파구', value:'팡팡락볼링장', address: "서울 송파구 올림픽로 114" },
    { region: '송파구', value:'제이에스비 거여지점', address: "서울 송파구 거마로 14 지하1층" },
  ...
  20:[
    { region: '영등포구', value:'코오롱스포렉스', address: "서울 영등포구 영중로 15 타임스퀘어 5F 501" },
    ...
    { region: '영등포구', value:'퍼스트비앤피', address: "서울 영등포구 국회대로 800 진미파라곤 지하2층" },
    { region: '영등포구', value:'동양볼링센터', address: "서울 영등포구 선유로 27 대륭오피스텔" },
    { region: '영등포구', value:'제이앤제이볼링센터', address: "서울 영등포구 영중로 12 에쉐르아이쇼핑몰 6층" },
    { region: '영등포구', value:'브래그볼링센터', address: "서울 영등포구 국회대로36길 17 지하1층" },
  ],
  21:[
    { region: '용산구', value:'스매싱볼', address: "서울 용산구 이태원로 145 지하1층" },
  ...
  22:[
    { region: '은평구', value:'가인볼링센터', address: "서울 은평구 통일로 1050 4층" },
